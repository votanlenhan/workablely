...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'API Hello World'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _fetchApiMessage() async {
    ...
    // TODO: Consider making the base URL configurable for physical devices/production
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw DioException(requestOptions: response.requestOptions, response: response, message: 'Non-200 status code');
      }
    } catch (e) {
      print('Error fetching API message: $e');
      setState(() {
