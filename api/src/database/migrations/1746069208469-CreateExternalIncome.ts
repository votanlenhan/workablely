...
export class CreateExternalIncome1746069208469 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "external_incomes" ADD CONSTRAINT "FK_7d1f8d67ca9aebbcdd263284490" FOREIGN KEY ("recorded_by_user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "external_incomes" DROP CONSTRAINT "FK_7d1f8d67ca9aebbcdd263284490"`);
