...
export class CreateEquipmentAssignment1746069491446 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "equipment_assignments" ADD CONSTRAINT "FK_ae74796876e22fdca33bcf3b8db" FOREIGN KEY ("show_id") REFERENCES "shows"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "equipment_assignments" DROP CONSTRAINT "FK_ae74796876e22fdca33bcf3b8db"`);
